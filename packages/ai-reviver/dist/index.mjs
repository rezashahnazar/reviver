...
import { useState as useState2, useRef, useTransition } from "react";
...
var ReviverContext = createContext(null);
...
var keyPointsSchema = z.array(keyPointSchema);
...
var suggestionsSchema = z.array(suggestionSchema);
...
function Vivify({ children, additionalContext }) {
  ...
  const [currentAction, setCurrentAction] = useState2(null);
      ...
      children: [
        ...
        /* @__PURE__ */ jsx3(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx3(MagicWandIcon, { className: "w-4 h-4" })
          }
        ),
        /* @__PURE__ */ jsx3(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsx3(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs2("div", { className: "p-4", children: [
              /* @__PURE__ */ jsxs2("div", { className: "flex justify-between items-center mb-4", children: [
                /* @__PURE__ */ jsx3("h3", { className: "font-semibold text-gray-900", children: "AI Actions" }),
                /* @__PURE__ */ jsx3(
                  "button",
                  {
                    onClick: handleClose,
              ...
              /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: ["summarize", "explain", "keyPoints"].map((action) => /* @__PURE__ */ jsxs2(
                "button",
                {
                  ...
                  children: [
                    isPending && action === currentAction && /* @__PURE__ */ jsx3(UpdateIcon, { className: "w-4 h-4 animate-spin" }),
                    action.charAt(0).toUpperCase() + action.slice(1)
                  ]
                },
                action
              )) }),
              result && /* @__PURE__ */ jsx3("div", { className: "mt-4 p-3 bg-gray-50 rounded-lg max-h-[60vh] overflow-y-auto", children: /* @__PURE__ */ jsx3("div", { className: "prose prose-sm max-w-none", children: /* @__PURE__ */ jsx3(Markdown, { children: result }) }) })
            ] })
          }
        ) })
      ]
...
import { useState as useState3, useTransition as useTransition2 } from "react";
import { motion as motion2, AnimatePresence as AnimatePresence2 } from "framer-motion";
import { UpdateIcon as UpdateIcon2 } from "@radix-ui/react-icons";
...
function OnClickInterceptor({
  ...
  const [currentOption, setCurrentOption] = useState3(null);
...
Implementation: ${s.implementation}` : ""}`
  ...
  return /* @__PURE__ */ jsxs3(Fragment2, { children: [
    /* @__PURE__ */ jsx4("div", { onClick: handleClick, children }),
    /* @__PURE__ */ jsx4(AnimatePresence2, { children: isOpen && /* @__PURE__ */ jsxs3(
      motion2.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs3(
            motion2.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx4("h2", { className: "text-lg font-semibold text-gray-900", children: "AI Options Available" }),
                /* @__PURE__ */ jsx4("div", { className: "space-y-2", children: onInterceptOptions.map((option) => /* @__PURE__ */ jsxs3(
                  "button",
                  {
                    ...
                    children: [
                      isPending && option.label === currentOption && /* @__PURE__ */ jsx4(UpdateIcon2, { className: "w-4 h-4 animate-spin" }),
                      isPending && option.label === currentOption ? "Processing..." : option.label
                    ]
                  },
                  option.label
                )) }),
                result && /* @__PURE__ */ jsx4(
                  motion2.div,
                  {
                    initial: { opacity: 0, y: 10 },
                    animate: { opacity: 1, y: 0 },
                    className: "mt-4 p-4 bg-gray-50 rounded-md max-h-[60vh] overflow-y-auto",
                    children: /* @__PURE__ */ jsx4("div", { className: "prose prose-sm max-w-none", children: /* @__PURE__ */ jsx4(
                      Markdown,
                      {
                        components: {
                          p: ({ children: children2 }) => /* @__PURE__ */ jsx4("p", { className: "mb-4", children: children2 }),
                          strong: ({ children: children2 }) => /* @__PURE__ */ jsx4("strong", { className: "font-semibold text-purple-700", children: children2 })
                        },
                        children: result
                      }
                    ) })
                ...
                /* @__PURE__ */ jsxs3("div", { className: "flex justify-end gap-3 mt-6", children: [
                  /* @__PURE__ */ jsx4(
                    "button",
                    {
                      onClick: handleClose,
...
import { MagicWandIcon as MagicWandIcon2, ReloadIcon } from "@radix-ui/react-icons";
import { readStreamableValue as readStreamableValue2 } from "ai/rsc";
...
function ReviverTextArea({
  ...
  const [inlineCompletion, setInlineCompletion] = useState4(null);
  const [isPending, startTransition] = useTransition3();
  const { setLoadingActions } = useReviverContext();
  const suggestionTimeoutRef = useRef2(void 0);
  const completionTimeoutRef = useRef2(void 0);
      ...
      if (newValue.trim().length > 10) {
        suggestionTimeoutRef.current = setTimeout(async () => {
          ...
          try {
            ...
            if (response.object) {
              const stream = readStreamableValue2(response.object);
              for await (const partialObject of stream) {
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "space-y-2", style: { marginBottom: "2rem" }, children: [
    /* @__PURE__ */ jsx5("div", { className: "space-y-1", children: label && /* @__PURE__ */ jsx5("label", { className: "block text-sm font-medium text-gray-700", children: label }) }),
    /* @__PURE__ */ jsx5("div", { className: "relative", children: /* @__PURE__ */ jsxs4("div", { className: "relative font-mono", children: [
      /* @__PURE__ */ jsx5(
        "textarea",
        {
          ...props,
      ...
      inlineCompletion && /* @__PURE__ */ jsx5(
        "div",
        {
          "aria-hidden": "true",
          ...
          children: /* @__PURE__ */ jsxs4(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx5("span", { className: "invisible", children: value }),
                /* @__PURE__ */ jsx5("span", { className: "text-gray-400/70", children: inlineCompletion?.slice(String(value).length) })
              ]
            }
          )
        }
      ),
      /* @__PURE__ */ jsxs4("div", { className: "absolute bottom-3 right-3 flex items-center gap-4 bg-white/80 backdrop-blur-sm rounded-md p-1", children: [
        inlineCompletion && /* @__PURE__ */ jsxs4("p", { className: "text-xs text-gray-500", children: [
          "Press",
          " ",
          /* @__PURE__ */ jsx5("kbd", { className: "px-1.5 py-0.5 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded", children: "Tab" }),
          " ",
          "to accept"
        ] }),
        /* @__PURE__ */ jsxs4("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx5(
            motion3.button,
            {
              ...
              children: /* @__PURE__ */ jsx5(ReloadIcon, { className: "w-3.5 h-3.5" })
            }
          ),
          /* @__PURE__ */ jsx5(
            motion3.button,
            {
              ...
              children: /* @__PURE__ */ jsx5(MagicWandIcon2, { className: "w-3.5 h-3.5" })
            }
          )
        ] })
      ] })
    ] }) }),
    error && /* @__PURE__ */ jsx5("div", { className: "mt-2 p-2 text-sm text-red-600 bg-red-50 rounded-lg", children: error }),
    /* @__PURE__ */ jsx5(AnimatePresence3, { children: suggestions.length > 0 && /* @__PURE__ */ jsx5(
      motion3.div,
      {
        ...
        children: suggestions.map((suggestion, index2) => /* @__PURE__ */ jsxs4(
          motion3.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx5("p", { className: "text-xs text-gray-600 line-clamp-1", children: suggestion.content })
            ]
          },
          index2
        ))
...
import { useEffect as useEffect2, useState as useState5, useRef as useRef3 } from "react";
import { readStreamableValue as readStreamableValue3 } from "ai/rsc";
function ReviverObserver({ onDataCollected }) {
  const [timeSpent, setTimeSpent] = useState5(0);
  const [idle, setIdle] = useState5(false);
  const [scrollDepth, setScrollDepth] = useState5(0);
  const { setLoadingActions } = useReviverContext();
  const idleTimerRef = useRef3(void 0);
  const dataCollectionTimerRef = useRef3(void 0);
  useEffect2(() => {
    ...
    dataCollectionTimerRef.current = setInterval(async () => {
      ...
      try {
        ...
        if (response.object) {
          const stream = readStreamableValue3(response.object);
          for await (const partialObject of stream) {
            if (partialObject?.suggestions) {
              onDataCollected?.({
                ...data,
...
import { motion as motion4, AnimatePresence as AnimatePresence4 } from "framer-motion";
import { jsx as jsx6, jsxs as jsxs5 } from "react/jsx-runtime";
function GlobalOverlay({ className }) {
  const { loadingActions } = useReviverContext();
  const isActive = loadingActions.length > 0;
  return /* @__PURE__ */ jsx6(AnimatePresence4, { children: isActive && /* @__PURE__ */ jsxs5(
    motion4.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      ...
      children: [
        /* @__PURE__ */ jsx6("svg", { className: "fixed inset-0 w-0 h-0", children: /* @__PURE__ */ jsxs5("defs", { children: [
          /* @__PURE__ */ jsxs5("filter", { id: "magical-flow-primary", children: [
            /* @__PURE__ */ jsx6(
              "feTurbulence",
              {
                type: "fractalNoise",
            ...
            /* @__PURE__ */ jsx6("feDisplacementMap", { in: "SourceGraphic", scale: "120" }),
            /* @__PURE__ */ jsx6("feGaussianBlur", { stdDeviation: "4" }),
            /* @__PURE__ */ jsx6(
              "feColorMatrix",
              {
                type: "matrix",
          ...
          /* @__PURE__ */ jsxs5("filter", { id: "magical-flow-secondary", children: [
            /* @__PURE__ */ jsx6(
              "feTurbulence",
              {
                type: "turbulence",
            ...
            /* @__PURE__ */ jsx6("feDisplacementMap", { in: "SourceGraphic", scale: "40" }),
            /* @__PURE__ */ jsx6("feGaussianBlur", { stdDeviation: "2" }),
            /* @__PURE__ */ jsx6(
              "feColorMatrix",
              {
                type: "matrix",
          ...
          /* @__PURE__ */ jsxs5("filter", { id: "magical-glow", children: [
            /* @__PURE__ */ jsx6("feGaussianBlur", { stdDeviation: "6" }),
            /* @__PURE__ */ jsx6(
              "feColorMatrix",
              {
                type: "matrix",
...
import { useState as useState15, useEffect as useEffect16, useRef as useRef12, useMemo as useMemo5 } from "react";
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx12(PortalProvider, { scope: __scopeDialog, forceMount, children: React25.Children.map(children, (child) => /* @__PURE__ */ jsx12(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx12(Portal, { asChild: true, container, children: child }) })) });
};
...
import React__default, { useLayoutEffect as useLayoutEffect4, useEffect as useEffect15, useMemo as useMemo4 } from "react";
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? useLayoutEffect4 : useEffect15;
...
function useScaleBackground() {
  ...
  const initialBackgroundColor = useMemo4(() => document.body.style.backgroundColor, []);
  function getScale() {
...
var Overlay2 = /* @__PURE__ */ React__default.forwardRef(function({ ...rest }, ref) {
...
var Content2 = /* @__PURE__ */ React__default.forwardRef(function({ onPointerDownOutside, style, onOpenAutoFocus, ...rest }, ref) {
...
var Handle = /* @__PURE__ */ React__default.forwardRef(function({ preventCycle = false, children, ...rest }, ref) {
...
var Yt = ({ visible: n, className: e }) => E.createElement("div", { className: ["sonner-loading-wrapper", e].filter(Boolean).join(" "), "data-visible": n }, E.createElement("div", { className: "sonner-spinner" }, te.map((t, a) => E.createElement("div", { className: "sonner-loading-bar", key: `spinner-bar-${a}` }))));
...
var Ft = () => {
  let [n, e] = $t.useState(document.hidden);
  return $t.useEffect(() => {
    let t = () => {
      e(document.hidden);
    };
  ...
  constructor() {
    ...
    this.promise = (e, t) => {
      ...
      let u = e instanceof Promise ? e : e(), f = a !== void 0, w, S = u.then(async (i) => {
        if (w = ["resolve", i], re2.isValidElement(i)) f = false, this.create({ id: a, type: "default", message: i });
        else if (ie(i) && !i.ok) {
          f = false;
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = o.useState(null), [lt, J] = o.useState(null), [W, H] = o.useState(false), [A, mt] = o.useState(false), [L, z3] = o.useState(false), [ct, d] = o.useState(false), [h, y] = o.useState(false), [R, j] = o.useState(0), [p, _] = o.useState(0), O = o.useRef(t.duration || X || Wt), G = o.useRef(null), k = o.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = o.useMemo(() => S.findIndex((r) => r.toastId === t.id) || 0, [S, t.id]), Jt = o.useMemo(() => {
    var r;
  ...
  }, className: M(s == null ? void 0 : s.cancelButton, (At = t == null ? void 0 : t.classNames) == null ? void 0 : At.cancelButton) }, t.cancel.label) : null, xt(t.action) ? t.action : t.action && tt(t.action) ? o.createElement("button", { "data-button": true, "data-action": true, style: t.actionButtonStyle || l, onClick: (r) => {
    var m, c;
...
function ReviverDrawer({
  ...
  const [isActionLoading, setIsActionLoading] = useState15(false);
  const [localStreamResult, setLocalStreamResult] = useState15(null);
  const [shouldShowLoading, setShouldShowLoading] = useState15(false);
  const hasToastShown = useRef12(false);
  const [isOpen, setIsOpen] = useState15(false);
  const originalHandlerRef = useRef12({ handler: null, element: null });
  useEffect16(() => {
    if (!React27.isValidElement(trigger)) return;
  ...
  const wrappedTrigger = useMemo5(() => {
    if (!React27.isValidElement(trigger)) return trigger;
    const triggerElement = trigger;
    return React27.cloneElement(triggerElement, {
      onClick: (e) => {
  ...
  return /* @__PURE__ */ jsxs7(
    Drawer.Root,
    {
      ...
      shouldScaleBackground,
      children: [
        /* @__PURE__ */ jsx13(Drawer.Trigger, { asChild: true, children: wrappedTrigger }),
        /* @__PURE__ */ jsx13(Drawer.Portal, { children: /* @__PURE__ */ jsxs7("div", { className: "fixed inset-0 z-50", children: [
          /* @__PURE__ */ jsx13(Drawer.Overlay, { className: "fixed inset-0 bg-black/40 backdrop-blur-sm" }),
          /* @__PURE__ */ jsx13("div", { className: "fixed inset-0 overflow-hidden", children: /* @__PURE__ */ jsx13("div", { className: "flex min-h-full items-center justify-center p-4", children: /* @__PURE__ */ jsx13(
            Drawer.Content,
            {
              style: {
                position: "relative",
              ...
              children: /* @__PURE__ */ jsxs7("div", { className: "flex flex-col flex-1 min-h-0", children: [
                /* @__PURE__ */ jsxs7("div", { className: "shrink-0 p-6 pb-4 border-b border-gray-200 dark:border-gray-800", children: [
                  title && /* @__PURE__ */ jsx13(Drawer.Title, { className: "text-xl font-semibold mb-2 text-gray-900 dark:text-white", children: title }),
                  description && /* @__PURE__ */ jsx13(Drawer.Description, { className: "text-gray-600 dark:text-gray-400", children: description })
                ] }),
                /* @__PURE__ */ jsx13("div", { className: "flex-1 overflow-y-auto p-6 min-h-0", children: /* @__PURE__ */ jsxs7("div", { className: "relative h-full", children: [
                  /* @__PURE__ */ jsx13(
                    "div",
                    {
                      className: cn(
                ...
                /* @__PURE__ */ jsx13("div", { className: "shrink-0 border-t border-gray-200 dark:border-gray-800 p-4 bg-gray-50 dark:bg-gray-900 rounded-b-xl", children: /* @__PURE__ */ jsxs7("div", { className: "flex justify-end gap-3", children: [
                  /* @__PURE__ */ jsx13(Drawer.Close, { asChild: true, children: /* @__PURE__ */ jsx13(
                    "button",
                    {
