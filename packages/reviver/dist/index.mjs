...
function ReviverDrawer({
  ...
  return /* @__PURE__ */ jsxs7(Drawer.Root, { shouldScaleBackground, children: [
    /* @__PURE__ */ jsx13(Drawer.Trigger, { asChild: true, children: trigger }),
        ...
        Drawer.Content,
        {
          ...
          children: /* @__PURE__ */ jsxs7("div", { className: "flex flex-col flex-1 min-h-0", children: [
            ...
            /* @__PURE__ */ jsx13("div", { className: "flex-1 overflow-y-auto p-6 min-h-0", children: /* @__PURE__ */ jsxs7("div", { className: "relative h-full", children: [
              (isProcessing || isActionLoading) && /* @__PURE__ */ jsx13("div", { className: "absolute inset-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-lg z-10", children: /* @__PURE__ */ jsx13(
                "div",
                {
