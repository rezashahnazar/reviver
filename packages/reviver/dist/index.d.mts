...
declare function ReviverDrawer({ trigger, title, description, children, isProcessing, className, shouldScaleBackground, onAction, onClearResults, streamResult, }: ReviverDrawerProps): react_jsx_runtime.JSX.Element;
